  ...
  <body>
    ...
    <div id="navbar" class="group">
		...
		<ul class="group">
			...
			<li><a class="rightBar active" href="signup.php">Sign Up</a></li>
		</ul>
	...
	<div id="content"> 
		...
		<div class="column middle">
            <form id="form" style="margin-top: 50px;" action=<?php echo $_SERVER['PHP_SELF']?> >
                ...
                <input type="text" id="nickname" name="firstname" placeholder="Your nickname..">
				
                <label for="email">Email</label>
                <input type="text" id="email" name="mail" placeholder="Your email..">

                <label for="password">Password</label>
                <input type="password" id="lnapasswordme" name="lastname" placeholder="">
